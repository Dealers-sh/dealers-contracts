...
contract DealersActionsTest is BaseTest {
    uint256 dealerToken;
    ...
    function test_sellDrop_revertNotInBlackMarket() public {
        ...
        vm.prank(player1);
        vm.expectRevert(DealersActions.NotInBlackMarket.selector);
    ...
    function test_sellDrop_revertNotSellableDrop() public {
        ...
        vm.prank(player1);
        vm.expectRevert(DealersActions.NotSellableDrop.selector);
    ...
    function test_sellDrop_revertZeroAmount() public {
        ...
        vm.prank(player1);
        vm.expectRevert(DealersActions.InvalidAmount.selector);
