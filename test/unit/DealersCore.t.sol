...
contract DealersCoreTest is BaseTest {
    ...
    function test_initializeDealer_revertIfAlreadyInitialized() public {
        ...
        vm.expectRevert(DealersCore.DealerAlreadyInitialized.selector);
    ...
    function test_initializeDealer_revertIfNotAuthorized() public {
        ...
        vm.prank(player1);
        vm.expectRevert(DealersCore.NotAuthorized.selector);
    ...
    function test_getReputationChange_byTier() public {
        ...
        IDealersCore.GameState memory gsHigh = core.getGameState(tokenId1);
    ...
    function test_updateDrugBalance_revertInsufficientBalance() public {
        ...
        vm.expectRevert(DealersCore.InsufficientDrugBalance.selector);
    ...
    function test_updateDrugBalance_revertInvalidDrug() public {
        ...
        vm.expectRevert(DealersCore.InvalidDrug.selector);
    ...
    function test_payBail_revertNotInJail() public {
        vm.prank(player1);
        vm.expectRevert(DealersActions.NotInJail.selector);
    ...
    function test_applyBoost_setsValues() public {
        ...
        IDealersCore.BoostData memory boost = core.getBoost(tokenId1);
    ...
    function test_applyBoost_extendsExistingBoost() public {
        ...
        IDealersCore.BoostData memory boostFirst = core.getBoost(tokenId1);
        uint64 firstExpiry = boostFirst.expiresAt;

        core.applyBoost(tokenId1, 1 days, 200, 150, 3, false, 150);

        IDealersCore.BoostData memory boostSecond = core.getBoost(tokenId1);
    ...
    function test_spendCash_revertInsufficientCash() public {
        ...
        vm.expectRevert(DealersCore.InsufficientCash.selector);
    ...
    function test_moveToArea_revertCannotEnterJail() public {
        ...
        vm.expectRevert(DealersCore.CannotEnterJail.selector);
    ...
    function test_moveToArea_checksRepRequirement() public {
        ...
        vm.expectRevert(DealersCore.InsufficientReputation.selector);
    ...
    function test_setReputationTiers_setsAll() public {
        IDealersCore.ReputationTier[] memory newTiers = new IDealersCore.ReputationTier[](2);

        newTiers[0] = IDealersCore.ReputationTier({
            minReputation: 0,
            winBonus: 10,
            tieBonus: 5,
            lossPenalty: -2,
        ...
        newTiers[1] = IDealersCore.ReputationTier({
            minReputation: 100,
            winBonus: 20,
            tieBonus: 10,
            lossPenalty: -5,
        ...
        IDealersCore.GameState memory gs0 = core.getGameState(tokenId1);
    ...
    function test_travel_revertNotDealerOwner() public {
        vm.prank(player2);
        vm.expectRevert(DealersActions.NotDealerOwner.selector);
    ...
    function test_travel_revertAlreadyInArea() public {
        ...
        vm.prank(player1);
        vm.expectRevert(DealersActions.AlreadyInArea.selector);
        actions.travel{value: 0.001 ether}(tokenId1, 1);
    }
    ...
    function test_travel_emitsDealerTraveledEvent() public {
        ...
        vm.expectEmit(true, false, false, true);
        emit DealersActions.DealerTraveled(tokenId1, 1, brooklynId, 0, true);
